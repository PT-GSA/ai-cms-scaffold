...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-black flex">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 border-r border-purple-600 transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}>
        <div className="bg-black flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-purple-600">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">AI CMS</span>
            </div>
            <button
          ...
          {/* Navigation */}
          <nav className="bg-black flex-1 px-4 py-6 space-y-2">
            <SidebarItem
          ...
          <div className="p-4 border-t border-purple-600">
            <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-800 hover:bg-gray-700 transition-colors">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header */}
        <header className="h-16 bg-black border-b border-purple-600 flex items-center justify-between px-6">
          <button
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-2 bg-black border border-purple-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-64"
              />
            </div>
